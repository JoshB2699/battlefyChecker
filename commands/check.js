module.exports = function(msg, config) {
  ...
  const battlefyRegex = RegExp('battlefy.com/teams/');
  if(battlefyRegex.test(team_url)){
    ...
    msg.channel.send('Invalid battlefy team url entered.\nShould be of the form `battlefy.com/teams/id` or `https://battlefy.com/teams/id`')
  }
}
